            ...
            <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
              <DrawerTrigger asChild>
                <Button
                  variant='outline'
                  size='icon'
                  className='border size-10 rounded-xl p-2 hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-colors duration-300 sm:hidden cursor-pointer'
                >
                  <IconMenu2 />
...
const ScrollToTopButton = () => {
  ...
  return (
    <Button
      variant='outline'
      size='icon'
      className='size-10 bg-zinc-900/80! backdrop-blur-md rounded-xl p-2 hover:scale-110 duration-300 fixed bottom-4 right-8 md:right-20 cursor-pointer'
      onClick={() => {
        window.scrollTo({
          top: 0,
          behavior: 'smooth'
