    ...
    <div className='w-full md:px-10' ref={containerRef}>
      <div className='max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10'>
        ...
        <p className='text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-3xl italic'>
          I started my journey at FPT Software, where I learned real development
          workflows and built my foundation in frontend engineering. After that,
          I spent over a year at QKIT Software as a Front-end Developer,
          building reusable components and integrating REST APIs across HR
          systems. For the past year, I’ve continued growing as a freelance
          developer — and the journey continues. <br /> Here’s a timeline of my
          journey.
        </p>
      </div>
